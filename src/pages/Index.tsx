        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              ...
              <img 
                src="https://cdn.poehali.dev/projects/b656551a-4437-4096-9803-a7d4bffb75c0/files/a991df1d-5630-45a2-9ea6-ac058acf7427.jpg"
                alt="L-Карнитин PharmExpert 120 капсул"
